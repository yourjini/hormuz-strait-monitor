...
export function EconomyBanner() {
  return (
    ...
    >
      ...
      <div className="relative px-4 sm:px-5 py-3 sm:py-3.5 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
              <AdLabel size="sm" />
              <span className="text-[9px] text-[#6b5432] font-semibold tracking-wide">
                FactLens · 파트너 서비스
              </span>
            </div>
            <div className="text-[#1a1509] text-xs sm:text-sm font-bold leading-tight truncate">
              경제 뉴스 속{' '}
              <span className="underline decoration-2 underline-offset-2 decoration-[#d97706]">
                과장·왜곡
              </span>
              을 AI가 걸러드립니다
            </div>
