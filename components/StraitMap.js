    ...
    <div className="rounded-lg border border-[#2a4a6f] bg-[#182f4a] p-4">
      ...
      <div className="relative overflow-hidden rounded-lg">
        ...
        <div className="absolute top-2 right-2 z-20 flex flex-col gap-1">
          <button onClick={handleZoomIn} className="w-7 h-7 rounded bg-[#0e1e30]/90 backdrop-blur border border-[#2a4a6f] text-gray-300 hover:text-white hover:border-cyan-500/50 flex items-center justify-center text-sm font-bold transition-colors">+</button>
          <button onClick={handleZoomOut} className="w-7 h-7 rounded bg-[#0e1e30]/90 backdrop-blur border border-[#2a4a6f] text-gray-300 hover:text-white hover:border-cyan-500/50 flex items-center justify-center text-sm font-bold transition-colors">−</button>
          {zoom > 1 && (
            <button onClick={handleReset} className="w-7 h-7 rounded bg-[#0e1e30]/90 backdrop-blur border border-[#2a4a6f] text-gray-400 hover:text-white hover:border-cyan-500/50 flex items-center justify-center text-[10px] transition-colors">⟲</button>
          )}
          {zoom > 1 && (
        ...
        {/* Hover tooltip */}
        {hovered && (
          <div className="absolute top-3 right-12 z-20 bg-[#142840]/95 backdrop-blur border border-[#2a4a6f] rounded-lg p-3 text-xs shadow-lg min-w-[180px]">
