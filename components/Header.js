      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between">
        <div className="flex items-center gap-3 sm:gap-6 min-w-0">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <svg className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3" />
            </svg>
            <div>
              <h1 className="text-sm sm:text-base font-bold text-gray-100 tracking-tight leading-none">HORMUZ</h1>
              <p className="text-[8px] sm:text-[9px] text-gray-500 hidden sm:block">호르무즈 해협 실시간 모니터링</p>
            </div>
          </Link>
